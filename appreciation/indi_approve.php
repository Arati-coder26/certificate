...
<div class="container-fluid"> 
    <h5 class="pt-4">Certificate of Appreciation</h5>
     <div class="row">
        <div class="col-md-9">
            <?php
                    // Include config file
                    ...
                    $sql = "SELECT * FROM  appreciation WHERE satus='Approve'";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a  class='text-info' href='aread/". (($row['u_id'] !='') ? ($row['u_id']) : ($row['id']))  ."' title='View Record' data-toggle='tooltip'><span class='far fa-eye'></span></a>";
                                            
                                        echo "</td>";
                                      /*  echo "<td>";
                                        
                                            echo "<a  class='text-info' href='indi_details.php?id=". $row['id'] ."' title='View Details' data-toggle='tooltip'><span class='far fa-eye'></span></a>";
                    ...
                    <div class="col-md-3">
                        ...
                        $query = "SELECT * FROM appreciation WHERE satus='Approve'";

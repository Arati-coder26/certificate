                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav"><!-- <a class="nav-link" href="approve.php">All Certificate</a> --><a class="nav-link" href="http://localhost/certificate/approve/indi_approve.php">Approved Certificates</a><a class="nav-link" href="http://localhost/certificate/approve/indi_pending.php">Pending Certificates</a>
                                        </nav>
                                    </div>
                                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pagesCollapseError" aria-expanded="false" aria-controls="pagesCollapseError"
                                    ...
                                    ></a>
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav"><!-- <a class="nav-link" href="approve.php">All Certificate</a> --><a class="nav-link" href="http://localhost/certificate/approve/instititunal_approv.php">Approved Certificate</a><a class="nav-link" href="http://localhost/certificate/approve/instititunal_pending.php">Pending Certificate</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card ">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>Fill Individual Member Details</div>
                            <div class="card-body">
  ...
  <div class="bg-white text-dark">
    <form action="action.php" method="POST" >
        <div class="row">
            ...
            <div class="col form-group">
              <label for="exampleInputDob"><small>Date of Birth</small></label>  
              <input type="date" class="form-control" name="dob" placeholder="Dob" value="1970-01-01"
              min="1970-01-01">
            </div>
          </div>
          <div class="row">
            <div class="col form-group">
              <label for="exampleInputDesignation"><small>Designation</small></label>  
              <input type="text" class="form-control" name="designation" placeholder="Designation">
            </div>
            <div class="col form-group">
              <label for="exampleInputOrganisation"><small>Organisation</small></label>  
              <input type="text" class="form-control" name="organisation" placeholder="Organisation Name">
            </div>
            <div class="col form-group">
              <label for="exampleInputPhone"><small>Phone</small></label>  
              <input type="text" class="form-control"  id="phone" name="phone" placeholder="9999567900" pattern="{9999765600}">
          ...
          <div class="row">
            ...
            <div class="col form-group">
              <label for="exampleInputJoinDate"><small>Join </small></label>  

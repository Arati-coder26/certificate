     ...
     <div class="row">
        <div class="col-md-10">
            <?php
                    ...
                    $sql = "SELECT * FROM  institutional_member";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a  class='text-info' href='insti_read.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip'><span class='far fa-eye'></span></a>";
                    ...
                    <div class="col-md-2">
                        ...
                        $query = "SELECT * FROM institutional_member";

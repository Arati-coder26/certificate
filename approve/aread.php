...
if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
    ...
    $sql = "SELECT * FROM individual_member WHERE id = '".$userId."' OR u_id = '".$userId."'";
            ...
            <div class="card box-shadow rounded center shadow">
                  ...
                  <div class="card-body text-center">
                    <h5 class="card-title py-1">
                        ...
                        <h3 class="form-control-static text-uppercase" style="font-size: 1.7rem;"><?php echo $row["member_name"]; ?></h3>

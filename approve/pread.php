        ...
        <div class="col-md-8">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <a class="btn btn-dark btn-lg rounded-pill" href="member.php?em_id=<?php echo $row['id'];?>" download="member.php?em_id=<?php echo $row['id'];?>"><i class="fas fa-download"></i>&nbsp; &nbsp;<small>Download Certificate</small></a>

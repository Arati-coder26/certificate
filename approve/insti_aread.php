<?php
$webUrl = webUrlToPage()."/certificate/approve/";
...
if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
    ...
    $sql = "SELECT * FROM institutional_member WHERE id = '".$userId."' OR u_id = '".$userId."'";
    ...
    <div class="row">
        ...
        <div class="col-md-8 ">
            <div class="card box-shadow rounded center shadow  ">
                  <img src="<?= $webUrl ?>images/header.png" class="card-img-top" alt="...">
                  ...
                  <div class="card-body">
                    ...
                    <div class="col-md-6 text-center">
                        <img src="<?= $webUrl ?>images/signature.jpg" alt="..." class="align-right" style="width:100px;">
                        <hr style="width:70%;">
        ...
        <div class="col-md-8">
            <div class="row">
                <div class="col-md-4">
                 ...
                 <a class="btn btn-dark btn-lg rounded-pill" href="<?= $webUrl ?>insti_member.php?em_id=<?php echo $row['id'];?>" download="member.php?em_id=<?php echo $row['id'];?>"><i class="fas fa-download"></i>&nbsp; &nbsp;<small>Download Certificate</small></a>

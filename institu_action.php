...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        else if(empty(trim($organisation_name))){
        ...
        $uniqueUserId = random_generator(10,'alphabets');
 
            $query =  "INSERT INTO institutional_member(u_id,
            member_name,organisation_name,email,phone,country,state,city,street,pincode,join_date,expiry_date,payment_mode,reference,issue_date,satus) VALUES('$uniqueUserId','$member_name','$organisation_name','$email','$phone','$country','$state','$city','$street','$pincode','$join_date','$expiry_date','$payment_mode','$reference','$issue_date','$satus')";
